...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Taggchain " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"taggchaintools.com", "34.199.7.77"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"taggchaintools.com", "testnet-seed.taggchaintools.com"},
    {"xurious.com", "testnet-seed.tgc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Taggchain is probably already running."), addrBind.ToString().c_str());
        else
